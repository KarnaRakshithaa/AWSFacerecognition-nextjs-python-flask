...
def add_face_to_collection(source_img_bytes,image_name,COLLECTION_NAME):
    ...
    try:
        ...
        response = client.index_faces(CollectionId=COLLECTION_NAME, Image=request,
                                         ExternalImageId=image_name, QualityFilter='LOW', DetectionAttributes=['ALL'])
        ...
        lst=[]
        # lst.append(str(e))
        lst.append(("Do not give space for person name and Not Registerd face please try again"))
        print(lst)
        return lst
